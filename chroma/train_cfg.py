...
This script launches the training process for the Chroma model with CFG,
supporting multiple hardware platforms (CUDA, MPS, CPU).

It reads the `device` setting from `config_cfg.json`.
...
if __name__ == "__main__":
    ...
    with open('config_cfg.json', 'r') as f:
        config = json.load(f)
